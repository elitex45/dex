...
export class App extends React.Component {
  ...
  componentWillUnmount() {
    // We poll the user's balance, so we have to stop doing that when App
    // gets unmounted
  ...
  async _transferTokens(to, amount) {
    ...
    try {
      ...
      // We send the transaction, and save its hash in the App's state. This
      ...
      // Other errors are logged and stored in the App's state. This is used to
